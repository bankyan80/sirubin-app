...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!npsn || !nama) { // Hanya NPSN dan Nama yang wajib, field lain bisa dilengkapi nanti
      return NextResponse.json({ success: false, message: 'NPSN dan Nama wajib diisi' }, { status: 400 })
    }

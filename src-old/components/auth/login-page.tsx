              ...
              <div className="space-y-3">
                <div className="flex items-start gap-2.5">
                  ...
                  <p className="text-xs text-slate-500 leading-relaxed">
                    <span className="font-semibold text-slate-600">Admin:</span> username <code className="px-1.5 py-0.5 bg-slate-100 rounded text-slate-600 font-mono text-[11px]">admin</code> / password <code className="px-1.5 py-0.5 bg-slate-100 rounded text-slate-600 font-mono text-[11px]">admin456</code>
                  </p>
                </div>
                <div className="flex items-start gap-2.5">

...
import {
  ...
  ClipboardCheck, CheckCircle, Clock, Send, CalendarDays,
} from 'lucide-react'
            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-slate-50">
                {loading ? (
                  ...
                  <tr><td colSpan={8} className="text-center py-12"><FileText size={32} className="text-slate-300 mx-auto" /><p className="text-sm text-slate-400 mt-2">Belum ada laporan</p></td></tr>
                ) : laporan.map((l, i) => {
